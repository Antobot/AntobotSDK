...
typedef struct {
  ...
  uint8_t unit_selector; // Added by Dylan on 27-Oct-2021 to read more info from register
  uint8_t data_select; // Added by Dylan on 27-Oct-2021 to read from register
  uint8_t operation_mode; // Added by Dylan on 27-Oct-2021 to read operation mode
  uint8_t power_mode; // Added by Dylan on 27-Oct-2021 to read from register
  uint8_t system_trigger; // Added by Dylan on 27-Oct-2021 to read from register
  uint8_t temperature_source; // Added by Dylan on 27-Oct-2021 to read from register
  uint8_t axis_map_config; // Added by Dylan on 27-Oct-2021 to read from register
  uint8_t axis_map_sign; // Added by Dylan on 27-Oct-2021 to read from register
} IMURecord;
...
class BNO055I2CDriver {
  public:
    ...
    bool reset();
    IMURecord read();
    IMUCalibParam read_calib_data();
    bool write_calib_data();
    IMUCalibParam read_calib_params_from_file();
    bool write_calib_params_to_file(IMUCalibParam calib_params);
