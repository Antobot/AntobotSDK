...
namespace am_heading
{
    ...
    void AmHeading::initialise(){
        ...
        nh_.getParam("/am_heading_node/gps_topic", gpsTopic);
        nh_.getParam("/am_heading_node/imu_topic", imuTopic);
        nh_.getParam("/am_heading_node/odometry_topic", odometryTopic);
        nh_.getParam("/am_heading_node/wheel_odometry_topic", wheelodometryTopic);

        nh_.getParam("/am_heading_node/new", new_gps);
